export function drawObject( gl, model, shininess, color ){
  /*
...
export function lightIntesity( i, r, g, b){
  return [ i*r, i*g, i*b ];
}
...
export function Array2Buffer(array, iSize, nSize) {
...
export function Array2EBuffer(array, iSize, nSize) {
  var buffer = gl.createBuffer();
...
export function drawBuffer(vpbuf, vcbuf, start, nitems, gltype) {
